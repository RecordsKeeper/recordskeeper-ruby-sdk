...
class Wallet
  ...
  # puts hello
	...
	# hello = getPrivateKey 'mpC8A8Fob9ADZQA7iLrctKtwzyWTx118Q9'
	# puts hello
	...
	# hello = signMessage 'mpC8A8Fob9ADZQA7iLrctKtwzyWTx118Q9', 'test'
	# puts hello
	...
	# hello = verifyMessage 'mpC8A8Fob9ADZQA7iLrctKtwzyWTx118Q9', 'INgL7+qJCbestQcawLFMmyvY04MB8UDYv4sngM9AcCJ2DRO6ucZBk8gvxUgTvUyFy9+F4VaZXXv+x/mGCxo4UAk=', 'test'
	# puts hello
