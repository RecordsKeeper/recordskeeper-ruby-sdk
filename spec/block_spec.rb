...
module RecordsKeeperRubyLib
  class BlockTest < Test::Unit::TestCase
    ...
    def test_block_info
      ...
      assert_equal miner['miner'], @@net['mainaddress']
      ...
      assert_equal merkleroot['merkleroot'], @@net['samplemerkleroot']
    end
    def test_retrieveBlocks
      miner = JSON.parse Block.retrieveBlocks "10-20"
      assert_equal miner['miner'][1], @@net['mainaddress']
      ...
      assert_equal blockhash['blockhash'][4], @@net['sampleblockhash']
